  ...
  return (
    <Button
      ...
      className={cn(
        ...
        orientation === "horizontal" ? "top-1/2 left-3 -translate-y-1/2" : "-top-12 left-1/2 -translate-x-1/2 rotate-90",
        className
      )}
...
function CarouselNext({ className, variant = "outline", size = "icon", ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      className={cn(
        "absolute size-8 rounded-full",
        orientation === "horizontal" ? "top-1/2 right-3 -translate-y-1/2" : "-bottom-12 left-1/2 -translate-x-1/2 rotate-90",
        className
      )}
